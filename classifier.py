...
class GPT2SentimentClassifier(torch.nn.Module):
  ...
  def __init__(self, config):
    ...
    self.model_config = self.gpt.config
    ...
    self.classifier = torch.nn.Linear(self.model_config.hidden_size, config.num_labels)
  ...
  def forward(self, input_ids, attention_mask):
    ...
    pooled_output = self.dropout(last_token_hidden_state)
